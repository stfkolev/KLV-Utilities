#include <klv/reindexed_view.hpp>
...
typedef klv::reindexed_view<const std::vector<int>, const std::vector<size_t>> cview_t;
typedef klv::reindexed_view<      std::vector<int>, const std::vector<size_t>>  view_t;
...
TEST(ReindexedView, WithValueRange) {
    using irange = klv::value_range<std::size_t>;
