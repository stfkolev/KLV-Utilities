...
queue can be considered as a special kind of concurrent queue. *KLV* implements
a concurrent queue class, in header file ``<klv/concurrent_queue.hpp>``.

.. cpp:class:: template<T> concurrent_queue
...
.. code-block:: cpp
    ...
    #include <klv/concurrent_queue.hpp>
    #include <vector>
    #include <thread>
    #include <cstdio>
